...
@section('content_header')
    <h1 class="m-0">تعديل بيانات الحجز</h1>
@stop
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('type') is-invalid @enderror" 
                                ...
                                @foreach(\App\Models\Booking::getTypeOptions() as $value => $label)
                                    <option value="{{ $value }}" {{ old('type', $booking->type) == $value ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" 
                                           ...
                                           id="booking_from" 
                                           name="booking_from" 
                                           value="{{ old('booking_from', $booking->booking_from->format('Y-m-d\TH:i')) }}" 
                                           required>
                                    @error('booking_from')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" 
                                           ...
                                           id="booking_to" 
                                           name="booking_to" 
                                           value="{{ old('booking_to', $booking->booking_to->format('Y-m-d\TH:i')) }}" 
                                           required>
                                    @error('booking_to')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" 
                                           ...
                                           id="booking_price" 
                                           name="booking_price" 
                                           value="{{ old('booking_price', $booking->booking_price) }}" 
                                           required>
                                    @error('booking_price')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('currency_id') is-invalid @enderror" 
                                        ...
                                        @foreach($currencies as $currency)
                                            <option value="{{ $currency->id }}" {{ old('currency_id', $booking->currency_id) == $currency->id ? 'selected' : '' }}>
                                                {{ $currency->name }}
                                            </option>
                                        @endforeach
                                    </select>
