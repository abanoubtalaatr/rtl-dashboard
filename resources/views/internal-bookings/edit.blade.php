        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">تعديل بيانات الحجز الداخلي</h3>
                </div>
                <form action="{{ route('internal-bookings.update', $internalBooking) }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="room_name">اسم الغرفة <span class="text-danger">*</span></label>
                                    <input type="text" name="room_name" id="room_name" 
                                           class="form-control @error('room_name') is-invalid @enderror"
                                           value="{{ old('room_name', $internalBooking->room_name) }}" placeholder="مثال: 201" required>
                                    @error('room_name')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="number_of_people" id="number_of_people" 
                                           ...
                                           value="{{ old('number_of_people', $internalBooking->number_of_people) }}" min="1" placeholder="مثال: 15" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="trip_duration" id="trip_duration" 
                                           ...
                                           value="{{ old('trip_duration', $internalBooking->trip_duration) }}" min="1" placeholder="مثال: 40 دقيقة" required>
                                    @error('trip_duration')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <!-- من (From) - اختيار الموقع -->
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="departure_from_location_id">من (From) <span class="text-danger">*</span></label>
                                    <select name="departure_from_location_id" id="departure_from_location_id"
                                        class="form-control @error('departure_from_location_id') is-invalid @enderror" required>
                            ...
                            <!-- إلى (To) - اختيار الموقع -->
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="departure_to_location_id">إلى (To) <span class="text-danger">*</span></label>
                                    <select name="departure_to_location_id" id="departure_to_location_id"
                                        class="form-control @error('departure_to_location_id') is-invalid @enderror" required>
                                        <option value="">-- اختر الموقع --</option>
                                        @foreach($locations as $location)
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="return_driver_id" id="return_driver_id" 
                                        ...
                                        @foreach($drivers as $driver)
                                            <option value="{{ $driver->id }}" {{ old('return_driver_id', $internalBooking->return_driver_id) == $driver->id ? 'selected' : '' }}>
                                                {{ $driver->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" name="booking_to" id="booking_to" 
                                           ...
                                           value="{{ old('booking_to', $internalBooking->booking_to->format('Y-m-d\TH:i')) }}" required>
                                    @error('booking_to')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="return_duration_minutes" id="return_duration_minutes" 
                                           ...
                                           value="{{ old('return_duration_minutes', $internalBooking->return_duration_minutes) }}" min="1" placeholder="مثال: 40 دقيقة" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="return_from_location_id">من (From) - العودة <span class="text-danger">*</span></label>
                                    <select name="departure_from_location_id" id="departure_from_location_id"
                                            class="form-control @error('departure_from_location_id') is-invalid @enderror" required>
                                        <option value="">-- اختر الموقع --</option>
                                        @foreach($locations as $location)
                                            <option value="{{ $location->id }}"
                                                {{ old('departure_from_location_id', $internalBooking->departure_from_location_id) == $location->id ? 'selected' : '' }}>
                                                {{ $location->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="return_to_location_id">إلى (To) - العودة <span class="text-danger">*</span></label>
                                    <select name="return_to_location_id" id="return_to_location_id"
                                            class="form-control @error('return_to_location_id') is-invalid @enderror" required>
                                        <option value="">-- اختر الموقع --</option>
                                        @foreach($locations as $location)
                                            <option value="{{ $location->id }}"
                                                {{ old('return_to_location_id', $internalBooking->return_to_location_id) == $location->id ? 'selected' : '' }}>
                                                {{ $location->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="cost" id="cost" 
                                           ...
                                           value="{{ old('cost', $internalBooking->cost) }}" step="0.01" min="0" required>
                                    @error('cost')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('internal-bookings.show', $internalBooking) }}" class="btn btn-secondary">
