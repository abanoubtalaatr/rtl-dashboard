            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        @php
                            // Base query
                            $query = \App\Models\Booking::internal();
                        ...
                        <div class="col-md-6 text-right">
                            <a href="{{ route('internal-bookings.unreturned') }}" class="btn btn-warning mr-2">
                                <i class="fas fa-hourglass-half"></i> الحجوزات الغير مُرجعة  <span class="badge badge-danger fa-3x">{{ $count }}</span>
                            </a>
                    ...
                    <form method="GET" action="{{ route('internal-bookings.index') }}" class="mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-2 d-flex align-items-center">
                                <a href="{{ route('internal-bookings.index') }}" class="btn btn-secondary ml-2">
