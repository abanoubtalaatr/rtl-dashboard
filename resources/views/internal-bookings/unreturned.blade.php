...
@section('title', 'الحجوزات الداخلية الغير مُرجعة')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="m-0">
            <i class="fas fa-hourglass-half mr-2"></i>
            الحجوزات الداخلية الغير مُرجعة
        </h1>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-warning">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            <a href="{{ route('internal-bookings.index') }}" class="btn btn-light">
                ...
                <div class="card-body">
                    <!-- Search Form -->
                    <form method="GET" action="{{ route('internal-bookings.unreturned') }}" class="mb-3">
                        <div class="row">
                            <div class="col-md-4">
                                    ...
                                    <tr class="table-warning">
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group-vertical" role="group">
                                                <form action="{{ route('internal-bookings.toggle-return', $booking) }}" method="POST" class="mb-1">
                                                    @csrf
