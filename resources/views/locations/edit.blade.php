        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">تعديل بيانات الموقع: {{ $location->name }}</h3>
                </div>
                <form action="{{ route('locations.update', $location) }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="name">اسم الموقع <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="address" id="address" rows="3"
                                      ...
                                      placeholder="العنوان التفصيلي للموقع (اختياري)">{{ old('address', $location->address) }}</textarea>
                            @error('address')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
