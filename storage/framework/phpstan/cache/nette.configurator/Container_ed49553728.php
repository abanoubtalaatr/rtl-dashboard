...
class Container_ed49553728 extends _PHPStan_5adafcbb8\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0437(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_ed49553728 $container)
			{
	...
	public function createServiceContainer(): Container_ed49553728
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'XPC_FLAGS' => '0x0',
				'APP_DEBUG' => 'true',
				'APP_KEY' => 'base64:95O4StqzqzIjQWhWqC4fWNGC1O0G1D9OmBu/OIcK9kw=',
				'LINES' => '10',
				'XPC_SERVICE_NAME' => '0',
				'AWS_ACCESS_KEY_ID' => '',
				'SHELL_VERBOSITY' => '0',
